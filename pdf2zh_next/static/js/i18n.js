...
const translations = {
    en: {
        ...
        'upload.activity.error.title': 'Translation paused',
        ...
        'upload.activity.pill.ready': 'Ready',
        'upload.activity.pill.progress': 'Processing',
        'upload.activity.pill.complete': 'Completed',
        'upload.activity.pill.error': 'Needs attention',
        'upload.activity.view_latest': 'View latest item',
        ...
        'settings.tab.analytics': 'Usage Analytics',
        ...
        'settings.analytics.subtitle': 'Admin-only usage overview for recent translations',
        'settings.analytics.window': 'Time Window',
        'settings.analytics.days7': 'Last 7 days',
        'settings.analytics.days30': 'Last 30 days',
        'settings.analytics.days90': 'Last 90 days',
        'settings.analytics.refresh': 'Refresh Analytics',
        'settings.analytics.overview': 'Overview',
        'settings.analytics.users': 'Users',
        'settings.analytics.trends': 'Daily Trends',
        'settings.analytics.empty': 'No usage data yet',
        'settings.analytics.scope': 'Stats are calculated from newly created translation tasks within the selected time window.',
        'settings.analytics.loading': 'Loading analytics...',
        'settings.analytics.error': 'Failed to load analytics. Please try again later.',
        'settings.analytics.empty.users': 'No user activity in this time window yet.',
        'settings.analytics.empty.trends': 'No daily trend data in this time window yet.',
        'settings.analytics.total_users': 'Total Users',
        'settings.analytics.active_users': 'Active Users',
        'settings.analytics.total_tasks': 'Total Tasks',
        'settings.analytics.success_rate': 'Success Rate',
        'settings.analytics.total_tokens': 'Total Tokens',
        'settings.analytics.total_size': 'Total File Size',
        'settings.analytics.total_pages': 'Total Pages',
        'settings.analytics.last_activity': 'Last Activity',
        'settings.analytics.user': 'User',
        'settings.analytics.role': 'Role',
        'settings.analytics.admin': 'Admin',
        'settings.analytics.member': 'Member',
        'settings.analytics.last_login': 'Last Login',
        'settings.analytics.tasks': 'Tasks',
        'settings.analytics.completed': 'Completed',
        'settings.analytics.failed': 'Failed',
        'settings.analytics.tokens': 'Tokens',
        'settings.analytics.file_size': 'File Size',
        'settings.analytics.pages': 'Pages',
        'settings.analytics.date': 'Date',
    },
    ...
    zh: {
        ...
        'upload.activity.pill.ready': '准备就绪',
        'upload.activity.pill.progress': '翻译进行中',
        'upload.activity.pill.complete': '翻译已完成',
        'upload.activity.pill.error': '需要处理',
        'upload.activity.view_latest': '查看最新记录',
        ...
        'settings.analytics.title': '使用分析',
        'settings.analytics.subtitle': '管理员查看最近翻译使用情况',
        'settings.analytics.window': '统计时间',
        'settings.analytics.days7': '最近 7 天',
        'settings.analytics.days30': '最近 30 天',
        'settings.analytics.days90': '最近 90 天',
        'settings.analytics.refresh': '刷新统计',
        'settings.analytics.overview': '总览',
        'settings.analytics.users': '用户统计',
        'settings.analytics.trends': '每日趋势',
        'settings.analytics.empty': '暂无使用数据',
        'settings.analytics.scope': '以下统计基于所选时间范围内新创建的翻译任务。',
        'settings.analytics.loading': '正在加载使用分析...',
        'settings.analytics.error': '加载使用分析失败，请稍后重试。',
        'settings.analytics.empty.users': '当前时间范围内暂无用户使用记录。',
        'settings.analytics.empty.trends': '当前时间范围内暂无每日趋势数据。',
        'settings.analytics.total_users': '总用户数',
        'settings.analytics.active_users': '活跃用户数',
        'settings.analytics.total_tasks': '总任务数',
        'settings.analytics.success_rate': '成功率',
        'settings.analytics.total_tokens': '总 Token',
        'settings.analytics.total_size': '总文件大小',
        'settings.analytics.total_pages': '总页数',
        'settings.analytics.last_activity': '最近活动',
        'settings.analytics.user': '用户',
        'settings.analytics.role': '角色',
        'settings.analytics.admin': '管理员',
        'settings.analytics.member': '普通用户',
        'settings.analytics.last_login': '最近登录',
        'settings.analytics.tasks': '任务数',
        'settings.analytics.completed': '成功',
        'settings.analytics.failed': '失败',
        'settings.analytics.tokens': 'Token',
        'settings.analytics.file_size': '文件大小',
        'settings.analytics.pages': '页数',
        'settings.analytics.date': '日期',
    }
};
